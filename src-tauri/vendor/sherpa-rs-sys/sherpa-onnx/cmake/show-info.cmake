...
elseif(WIN32)
  # Typex patch: WMIC is removed from current Windows 11 and Server images.
  # CMake already exposes non-sensitive host OS information without an external tool.
  set(SHERPA_ONNX_OS "${CMAKE_HOST_SYSTEM_NAME} ${CMAKE_HOST_SYSTEM_VERSION}")
else()
