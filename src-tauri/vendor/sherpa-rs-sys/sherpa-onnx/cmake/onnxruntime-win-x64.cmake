...
# Typex patch: single-config generators such as Ninja do not define
# CMAKE_VS_PLATFORM_NAME. The target processor and pointer width are generator-neutral.
string(TOLOWER "${CMAKE_SYSTEM_PROCESSOR}" SHERPA_ONNX_SYSTEM_PROCESSOR_LOWER)
if(NOT (CMAKE_SIZEOF_VOID_P EQUAL 8 AND
        SHERPA_ONNX_SYSTEM_PROCESSOR_LOWER MATCHES "^(amd64|x86_64)$"))
  message(FATAL_ERROR
    "This file is for Windows x64 only. Given: ${CMAKE_SYSTEM_PROCESSOR}, ${CMAKE_SIZEOF_VOID_P}-byte pointers")
endif()
